...
# No heredar la URL real (Neon) del .env: un test no debe poder tocar producción.
# El engine es perezoso, así que esto solo importa si algún test abre sesión a propósito.
